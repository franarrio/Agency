              ...
              <div className="row">
                <div className="col-lg-12 text-center">
                  <h1 className="text-display-2">
                    Advanced <span className="color-green-900">development</span> to
                    <br className="d-lg-block d-none" />
                    grow your business
                  </h1>
                  <p className="text-body-lead-large color-gray-500 mt-40 pr-40">
                    Oracle-NetSuite solutions to support your business needs
                  </p>
                  <div className="mt-40 text-center">
                    <Link href="/contact-us" legacyBehavior>
                      <a className="btn btn-black icon-arrow-right-white">Get in touch</a>
                    </Link>
                    ...
                    <div className="col-lg-8">
                      <div className="banner-imgs">
                        <div className="block-1 shape-2">
                          <img src="/assets/imgs/page/services/2/banner2.png" alt="Agon" />
                        </div>
                        <div className="block-2 shape-2">
                          <img src="/assets/imgs/page/services/2/banner1.png" alt="Agon" />
                        </div>
                        <div className="block-3 shape-2">
                          <img src="/assets/imgs/page/services/2/banner3.png" alt="Agon" />
                        </div>
                        <img src="/assets/imgs/page/services/1/banner.png" alt="Agon" />
                      </div>
                    </div>
                    <div className="col-lg-2" />
                  </div>
              ...
              <div className="col-lg-12">
                <ul className="list-partners">
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-1.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-2.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-3.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-4.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-5.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-6.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-7.svg" />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="/#" legacyBehavior>
                      <a className="item-logo box-hover-shadow">
                        <img alt="Agon" src="assets/imgs/slider/logo/sample-logo-8.svg" />
                      </a>
                    </Link>
                  </li>
                </ul>
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="bg-2 box-square hover-up">
                  ...
                  <p className="text-body-text-md color-gray-600">
                    Your site is not complete with only landings. Get essential inner pages using our ready
                    demos.
                  </p>
            ...
            <div className="bg-2 bdrd-58 pattern-white none-pattern pb-60">
              <div className="row">
                ...
                <div className="col-lg-8 col-sm-10 col-12 text-center mt-70">
                  ...
                  <p className="text-body-lead-large color-gray-600 mt-20">
                    What makes us different from others? We give holistic solutions with strategy, design and
                    technology.
                  </p>
                </div>
                <div className="col-lg-2 col-sm-1 col-12" />
