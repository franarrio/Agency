            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-sm-12 block-we-do">
                ...
                <p className="text-body-lead-large color-gray-600 mt-30">
                  ...
                  publication news while still not being ready. Business advisory service advises current and
            ...
            <div className="row">
              <div className="col-lg-5 mb-30">
                ...
                <h3 className="text-heading-1 mt-30">
                  Do not take our word for it. See what our clients say.
                </h3>
                <p className="text-body-lead-large color-gray-600 mt-30">
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <div className="card-grid-style-2 card-square hover-up mb-20">
                      <p className="text-body-text color-gray-600 text-comment">
                        {
                          "No matter where you go, Its is the coolest, most happening thing around! Not able to tell you how happy I am with it. "
                        }
                      </p>
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <div className="card-grid-style-2 card-square hover-up mb-20">
                      <p className="text-body-text color-gray-600 text-comment">
                        {
                          "Wow what great service, I love it! Its is the most valuable business resource we have EVER purchased. We cant understand how we have been living without it. I couldnt have asked for more than this."
                        }
                      </p>
                      <div className="box-img-user">
                        <div className="img-user img-user-round">
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <div className="card-grid-style-2 card-square hover-up mb-20">
                      <p className="text-body-text color-gray-600 text-comment">
                        {
                          "Your company is truly upstanding and is behind its product 100%. Its the perfect solution for our business. It has really helped our business. Needless to say we are extremely satisfied with the results. "
                        }
                      </p>
                      <div className="box-img-user">
                        <div className="img-user img-user-round">
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <div className="card-grid-style-2 card-square hover-up mb-20">
                      <p className="text-body-text color-gray-600 text-comment">
                        {
                          "Its is both attractive and highly adaptable. Its exactly what I have been looking for. Definitely worth the investment."
                        }
                      </p>
                      <div className="box-img-user">
                        <div className="img-user img-user-round">
              ...
              <div className="col-lg-5 mb-40">
                ...
                <div className="mt-60">
                  ...
                  <Link href="/page-login" legacyBehavior>
                    <a className="btn btn-link text-heading-6">Support Center</a>
                  </Link>
                </div>
              </div>
              <div className="col-lg-7">
            ...
            <div className="row">
              <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                <div className="card-grid-style-4">
                  ...
                  <Link href="/blog-single" legacyBehavior>
                    <a className="text-heading-4">We can blend colors multiple ways, the most common</a>
                  </Link>
              ...
              <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                <div className="card-grid-style-4">
                  ...
                  <Link href="/blog-single" legacyBehavior>
                    <a className="text-heading-4">How To Blow Through Capital At An Incredible Rate</a>
                  </Link>
              ...
              <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                <div className="card-grid-style-4">
                  ...
                  <Link href="/blog-single" legacyBehavior>
                    <a className="text-heading-4">Design Studios That Everyone Should Know About?</a>
                  </Link>
              ...
              <div className="row">
                ...
                <div className="col-lg-8">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div className="form-group">
                        <input className="form-control" placeholder="Comapy (optioanl)" />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                    ...
                    <div className="col-lg-5 col-md-7">
                      ...
                      <div className="box-form-newsletter mt-30">
                        <form className="form-newsletter">
                          <input className="input-newsletter" placeholder="Enter you mail .." />
